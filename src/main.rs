...
fn main() {
    ...
    let ref m6 = math::Matrix::<f32, 3>::with_value([2, 8, 4], 8.0);
    let ref m7 = math::Matrix::<f32, 3>::with_value([2, 4, 9], 5.0);
    println!("{}", math::matmul(m6, m7));

    let ref v1 = math::Matrix::<f32, 1>::with_value([9], 5.0);

    println!("{:?}", math::matmul1d(v1, v1));
}
